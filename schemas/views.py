...
class SchemaCreate(View):
    ...
    def post(self, request):
        ...
        """create column(s) (SchemaTypes objects) for new schema object"""
   
        # get list of "POST" dictionary keys starting with 'column_name'
        cols = [item for item in request.POST if item.startswith('column_name')]
        ...
        for i in index_list:
            ...
            try:
                col_name = request.POST.get(f'column_name_{i}')
